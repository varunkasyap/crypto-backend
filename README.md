The API I used is **https://api.coingecko.com/api/v3/simple/price**. The documentation for this API is available at  **https://docs.coingecko.com/reference/simple-price** <br />
<br/>
